    ...
    return (
        <div className={`container py-5 my-5`}>
            <div className="row d-flex align-items-center">
                ...
                <div className="col-3 col-lg-6 d-flex justify-content-center ">
                    <div
                        className={`d-flex flex-column justify-content-center align-items-center ${styles['box-profile']}`}>
                        <div className={`text-center d-lg-block ${styles['bg-profile']}`}>
                            <Image
                                src={urlImg || "/img/Logo.png"}
                            ...
                            <div className="d-block">
                                ...
                                />
                                <label htmlFor="profileImage" className={ ` fs-16px ${styles[`uploadBtn`]}`}>
                                    انتخاب پــروفایل
                                </label>
                            </div>
